...
let uppercaseString = inputString.toLocaleUpperCase(); // Your code here
let trimmedString = inputString.trim(); // Your code here
let replacedString = inputString.replace("JavaScript", "Coding"); // Your code here
// 
// Student Question - do you have a preference on using backticks if we are not using a template literal? or can it all be backticks for standardizing.
